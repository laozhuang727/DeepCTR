...
def get_input_feature_names(feature_columns):
...
def get_linear_logit(input_layer_features, feature_columns, units=1, use_bias=False, init_std=0.0001, seed=1024,
                     prefix='linear',
                     l2_reg=0):
    linear_emb_list = [
        build_emd_layer_from_feature_columns(input_layer_features, feature_columns, 1, l2_reg, init_std, seed,
                                             prefix=prefix + str(i))[0] for i in range(units)]
    _, dense_input_list = build_emd_layer_from_feature_columns(input_layer_features, feature_columns, 1, l2_reg,
                                                               init_std, seed, prefix=prefix)
...
def build_emd_layer_from_feature_columns(features, feature_columns, embedding_size, l2_reg, init_std, seed, prefix='',
