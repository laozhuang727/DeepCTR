...
def MLR(region_feature_columns, base_feature_columns=None, region_num=4,
    ...
    :param region_feature_columns: An iterable containing all the input_layer_features used by region part of the model.
    :param base_feature_columns: An iterable containing all the input_layer_features used by base part of the model.
    ...
    :param bias_feature_columns: An iterable containing all the input_layer_features used by bias part of the model.
